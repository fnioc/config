// Shared publish-build logic for every @fnconfig/* package.
//
...
//      @fnconfig/config folds in @rhombus-toolkit/proxy-base (whose published
...
export interface BuildPackageOptions {
  ...
  readonly dir: string;
  /** The package name, for error messages (e.g. `"@fnconfig/config"`). */
   ...
   * runtime identity -- e.g. @fnconfig/config's barrel and its
