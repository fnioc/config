...
//
// Importing "@fnconfig/config/with-type-augment" brings the withType()
// declaration (and its throwing prototype stub) into scope. Without the real
// @fnconfig/transformer compile-time transform, calling it must fail loud
