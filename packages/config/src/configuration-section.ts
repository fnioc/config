...
import type { DeepRecord, IConfiguration, IConfigurationSection, IndexedSection } from "@fnconfig/core";
 ...
 */
export class ConfigurationSection extends IndexAccessed<IndexedSection>
