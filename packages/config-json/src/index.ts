// Public entry point for @fnioc/config-json.
//
// Exports JsonConfigurationSource/JsonConfigurationProvider and installs the
// `addJsonFile` sugar onto `@fnioc/config`'s ConfigurationBuilder via the
...
// the sugar) needs a bare side-effect import: `import "@fnioc/config-json";`
...
// "configuration-builder-subpath" note in @fnioc/config's package.json.
